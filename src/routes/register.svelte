            ...
            <div class="col-md-6 offset-md-3 col-xs-12">
                ...
                <form on:submit|preventDefault={submit}>
                    ...
                    <fieldset class="form-group">
                        ...
                        {#if password.length > 1 && password.length < 7}<sup><div class="alert alert-danger" role="alert">Password too short</div></sup>{/if}
                    </fieldset>
                    <button class="btn btn-lg btn-primary pull-xs-right" disabled="{password.length < 7}">
                        Sign up
                    </button>
                </form>
            </div>
